...
abstract class BytecodePredicateFinder extends BytecodeFinder {
    ...
    protected Object getData() {
        return matches.toSorted(Comparator.<String>naturalOrder()) ?: {throw new RuntimeException('Failed to find any targets, please ensure that method names and descriptors are correct.')}()
    }
}