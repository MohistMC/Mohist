...
public abstract class ModContainer
{
    ...
    public ModContainer(IModInfo info)
    {
        ...
        final String displayTestString = info.getConfig().<String>getConfigElement("displayTest")
                .orElseGet(() -> (Boolean) info.getOwningFile().getFileProperties().getOrDefault(net.minecraftforge.fml.loading.moddiscovery.ModFileInfo.CLIENT_SIDE_ONLY_PROP, Boolean.FALSE) ? "IGNORE_ALL_VERSION" : "MATCH_VERSION");
