...
/**
 * A faster implementation of {@link net.minecraft.util.IntIdentityHashBiMap} which makes use of a backing map from fastutil.
 */
@SuppressWarnings("unchecked")
public class LithiumIntIdentityHashBiMap<K> implements IObjectIntIterable<K> {
    private K[] lookupById;
    private final Object2IntMap<K> lookupByObj;
    private int size = 0;

    public LithiumIntIdentityHashBiMap(int capacity) {
