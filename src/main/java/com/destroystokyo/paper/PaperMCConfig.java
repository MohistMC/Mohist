...
public class PaperMCConfig {
    ...
    public static int minChunkLoadThreads = 4;

    private static void chunkLoadThreads() {
        minChunkLoadThreads = Math.min(6, getInt("settings.min-chunk-load-threads", 4)); // Keep people from doing stupid things with max of 6
    }
    // :>
