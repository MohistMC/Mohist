...
public class RedstoneWireTurbo {
    /*
     * This is Helper class for RedstoneWireTurbo.  It implements a minimally-invasive
     ...
     *
     * Features:
     * - Changes to RedstoneWireTurbo are very limited, no other classes are affected, and the
    ...
    /* Reference to RedstoneWireTurbo object, which uses this accelerator */
     ...
     * initial block update that came from a call to RedstoneWireTurbo.neighborChanged().
    ...
    private void identifyNode(final World worldIn, final UpdateNode upd1) {
        ...
        final BlockState oldState = worldIn.getType(pos);
        ...
        // One job of RedstoneWireTurbo.neighborChanged is to convert
        // redstone wires to items if the block beneath was removed.
        // With this accelerator, RedstoneWireTurbo.neighborChanged
    ...
    // Select whether to use updateSurroundingRedstone from RedstoneWireTurbo (old)
     ...
     * (3) This results in a call to RedstoneWireTurbo.neighborChanged for that other wire, in the middle of
     ...
     * few other methods in RedstoneWireTurbo.  This sets off the breadth-first
    ...
    public BlockState updateSurroundingRedstone(final World worldIn, final BlockPos pos, final BlockState state, final BlockPos source) {
        ...
        // Use the calculateCurrentChanges method in RedstoneWireTurbo since we have no
    ...
    private BlockState calculateCurrentChanges(final World worldIn, final UpdateNode upd) {
        ...
        final int i = state.get(RedstoneWireBlock.POWER).intValue();
        int j = 0;
        ...
        if (i != j) {
            ...
            if (wire.canSurvive(null, worldIn, pos)) {
                state = state.set(RedstoneWireBlock.POWER, Integer.valueOf(j));
    ...
    private static int getMaxCurrentStrength(final UpdateNode upd, final int strength) {
        ...
        final int i = upd.currentState.get(RedstoneWireBlock.POWER).intValue();
