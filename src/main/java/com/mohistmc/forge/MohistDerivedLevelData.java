...
public class MohistDerivedLevelData extends PrimaryLevelData {
    ...
    public MohistDerivedLevelData(LevelSettings worldSettings, WorldGenSettings generatorSettings, DerivedLevelData derivedWorldInfo, Lifecycle p_i232158_3_) {
        super(worldSettings, generatorSettings, p_i232158_3_);
    ...
    public static MohistDerivedLevelData create(DerivedLevelData worldInfo) {
        return new MohistDerivedLevelData(worldSettings(worldInfo), generatorSettings(worldInfo), worldInfo, lifecycle(worldInfo));
    }
