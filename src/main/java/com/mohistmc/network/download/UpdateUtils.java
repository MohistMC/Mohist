...
public class UpdateUtils {
  ...
  public static void versionCheck() {
    ...
    try {
      JsonElement root = new JsonParser().parse(new InputStreamReader(getInput("https://ci.codemc.io/job/Mohist-Community/job/Mohist-1.7.10/lastSuccessfulBuild/api/json")));
      ...
      if(jar_sha.equals(build_number))
        System.out.println(Message.getFormatString("update.latest", new Object[]{"1.0", jar_sha, build_number}));
      else {
        ...
        if(bMohist("check_update_auto_download"))
          downloadFile("mhttps://ci.codemc.io/job/Mohist-Community/job/Mohist-1.7.10/lastSuccessfulBuild/artifact/projects/mohist/build/libs/mohist-" + build_number + "-server.jar", new File(getMohistJar().getName()));
      }
    } catch (Throwable e) {
  ...
  public static HashMap<String, String> getLibs() {
    ...
    try {
      allLibsLines = Files.readAllLines(new File("D:\\CREATIONS DEV\\TEMP\\Mohist1710\\src\\main\\resources\\", "mohist_libraries.json").toPath());
