...
public class CoreModManager {
    ...
    private static String[] rootPlugins = { "net.minecraftforge.fml.relauncher.FMLCorePlugin", "net.minecraftforge.classloading.FMLForgePlugin", "com.mohistmc.forge.MohistCorePlugin" };
