                ...
                (root, file) ->
                {
                    ...
                    if (!map.containsKey(key)) {
                        ...
                        try {
                            ...
                            Mohist.LOGGER.debug("Parsing error loading built-in advancement " + key, jsonparseexception);
                            return false;
                        } catch (IOException ioexception) {
                            Mohist.LOGGER.debug("Couldn't read advancement " + key + " from " + file, ioexception);
                            return false;
                        } finally {
