...
public class RemapUtils {
    ...
    static {
        ...
        relocations.put("net.minecraft.server", "net.minecraft.server.v1_15_R1");
        try {
            jarMapping.loadMappings(new BufferedReader(new InputStreamReader(Mohist.class.getClassLoader().getResourceAsStream("mappings/nms.srg"))), new MavenShade(relocations), null, false);
        } catch (IOException e) {
            e.printStackTrace();
        }
