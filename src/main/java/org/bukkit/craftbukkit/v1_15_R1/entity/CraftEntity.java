...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public static CraftEntity getEntity(CraftServer server, Entity entity) {
        ...
        if (entity instanceof LivingEntity) {
                ...
                // Monsters
                    ...
                    if (entity instanceof ZombieEntity) {
                        if (entity instanceof ZombiePigmanEntity) {
                            return new CraftPigZombie(server, (ZombiePigmanEntity) entity);
            ...
            if (part.dragon instanceof EnderDragonEntity) {
        ...
        } else if (entity instanceof LightningBoltEntity) {
            ...
            } else if (entity instanceof MinecartCommandBlockEntity) {
                return new CraftMinecartCommand(server, (MinecartCommandBlockEntity) entity);
            }
    ...
    public void setGlowing(boolean flag) {
        ...
        net.minecraft.entity.Entity e = getHandle();
        if (e.getFlag(6) != flag) {
            e.setFlag(6, flag);
        }
    }
