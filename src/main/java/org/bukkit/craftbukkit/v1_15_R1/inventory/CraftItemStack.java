...
public final class CraftItemStack extends ItemStack {
    ...
    static Map<Enchantment, Integer> getEnchantments(net.minecraft.item.ItemStack item) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String id = ((CompoundNBT) list.get(i)).getString(CraftMetaItem.ENCHANTMENTS_ID.NBT);
            int level = 0xffff & ((CompoundNBT) list.get(i)).getShort(CraftMetaItem.ENCHANTMENTS_LVL.NBT);
