...
public final class CraftFloorSign extends org.bukkit.craftbukkit.v1_15_R1.block.data.CraftBlockData implements org.bukkit.block.data.type.Sign, org.bukkit.block.data.Rotatable, org.bukkit.block.data.Waterlogged {
    ...
    // org.bukkit.craftbukkit.v1_15_R1.block.data.CraftRotatable

    private static final IntegerProperty ROTATION = getInteger(net.minecraft.block.StandingSignBlock.class, "rotation");
    ...
    private static final BooleanProperty WATERLOGGED = getBoolean(net.minecraft.block.StandingSignBlock.class, "waterlogged");
