...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public static Class<? extends org.bukkit.entity.Entity> getEntityClass(Class<? extends net.minecraft.entity.Entity> nmsClass) {
        ...
        if (net.minecraft.entity.EntityLivingBase.class.isAssignableFrom(nmsClass)) {
            ...
            */
            ...
            return CraftFallingBlock.class;
            ...
            } else if (EntityMinecartMobSpawner.class.isAssignableFrom(nmsClass)) {
            ...
            } else if (EntityMinecartCommandBlock.class.isAssignableFrom(nmsClass)) {
        ...
        } else if (EntityShulkerBullet.class.isAssignableFrom(nmsClass)) {
            return CraftShulkerBullet.class;
        } else if (EntityAreaEffectCloud.class.isAssignableFrom(nmsClass)) {
            return CraftAreaEffectCloud.class;
        } else if (EntityEvokerFangs.class.isAssignableFrom(nmsClass)) {
            return CraftEvokerFangs.class;
        } else if (EntityLlamaSpit.class.isAssignableFrom(nmsClass)) {
            return CraftLlamaSpit.class;
        }
        // Cauldron - used for custom entities that extend Entity directly
    ...
    public static void initMappings() {
        for (Map.Entry<String, Class<? extends Entity>> entry : EntityRegistry.entityClassMap.entrySet()) {
            Class<? extends Entity> entityClass = entry.getValue();
            String entityName = entry.getKey();
            int entityId = GameData.getEntityRegistry().getID(EntityRegistry.getEntry(entityClass));

            Class<? extends org.bukkit.entity.Entity> bukkitEntityClass = CraftEntity.getEntityClass(entityClass);
            ForgeInjectBukkit.addBukkitEntityType(entityName, bukkitEntityClass, entityId, false);
        }
    }
