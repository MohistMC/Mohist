...
public final class CraftServer implements Server {
    ...
    //changed gc period from `-1` to `10`
    // gc period at 10: clearing loaded chunks every 30 seconds leaving arround 800+ chunks loaded for 1 player

    public int chunkGCPeriod = 3;
    ...
    public void addWorld(World world) {
        ...
        if (getWorld(world.getUID()) != null) {
            Mohist.LOGGER.info(Message.getFormatString(Message.craftserver_addworld, new Object[]{world.getName()}));
            return;
        }
