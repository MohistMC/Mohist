...
public final class CraftDropper extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Dispenser, org.bukkit.block.data.Directional {
    ...
    private static final net.minecraft.state.property.BooleanProperty TRIGGERED = getBoolean(net.minecraft.block.DropperBlock.class, "triggered");
    ...
    private static final net.minecraft.state.property.EnumProperty<?> FACING = getEnum(net.minecraft.block.DropperBlock.class, "facing");
