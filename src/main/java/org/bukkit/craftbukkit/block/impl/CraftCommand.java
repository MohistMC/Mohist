...
public final class CraftCommand extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.CommandBlock, org.bukkit.block.data.Directional {
    ...
    private static final net.minecraft.state.property.BooleanProperty CONDITIONAL = getBoolean(net.minecraft.block.CommandBlock.class, "conditional");
    ...
    private static final net.minecraft.state.property.EnumProperty<?> FACING = getEnum(net.minecraft.block.CommandBlock.class, "facing");
