...
public final class CraftDispenser extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Dispenser, org.bukkit.block.data.Directional {
    ...
    private static final net.minecraft.state.property.BooleanProperty TRIGGERED = getBoolean(net.minecraft.block.DispenserBlock.class, "triggered");
    ...
    private static final net.minecraft.state.property.EnumProperty<?> FACING = getEnum(net.minecraft.block.DispenserBlock.class, "facing");
