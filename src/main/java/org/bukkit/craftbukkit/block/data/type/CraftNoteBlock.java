...
public abstract class CraftNoteBlock extends CraftBlockData implements NoteBlock {
    ...
    private static final net.minecraft.state.property.EnumProperty<?> INSTRUMENT = getEnum("instrument");
    private static final net.minecraft.state.property.IntProperty NOTE = getInteger("note");
