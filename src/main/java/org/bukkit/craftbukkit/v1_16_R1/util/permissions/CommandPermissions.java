package org.bukkit.craftbukkit.v1_16_R1.util.permissions;
...
public final class CommandPermissions {
    ...
    public static Permission registerPermissions(Permission parent) {
        ...
        DefaultPermissions.registerPermission(PREFIX + "msg", "Allows private messaging", PermissionDefault.TRUE, commands);
        DefaultPermissions.registerPermission(PREFIX + "help", "Allows use of /help", PermissionDefault.TRUE, commands);
