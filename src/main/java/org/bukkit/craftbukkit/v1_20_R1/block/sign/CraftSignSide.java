...
public class CraftSignSide implements SignSide {
    ...
    @Override
    public net.kyori.adventure.text.Component line(final int index) throws IndexOutOfBoundsException {
        this.loadLines();
        return this.lines.get(index);
    }

    @Override
    public void line(final int index, final net.kyori.adventure.text.Component line) throws IndexOutOfBoundsException {
    ...
    private void loadLines() {
        ...
        // Lazy initialization:
        this.lines = PaperAdventure.asAdventure(com.google.common.collect.Lists.newArrayList(this.signText.getMessages(false)));
