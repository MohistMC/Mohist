 ...
 *
 * <b>This event behaves similarly to {@link com.mohistmc.paper.event.player.AsyncChatEvent} in that it
...
public class BroadcastMessageEvent extends ServerEvent implements Cancellable {
    ...
    @Deprecated
    public BroadcastMessageEvent(net.kyori.adventure.text.Component message, @NotNull Set<CommandSender> recipients) {
        this(false, message, recipients);
    }

    public BroadcastMessageEvent(boolean isAsync, net.kyori.adventure.text.Component message, @NotNull Set<CommandSender> recipients) {
        // Paper end
        super(isAsync);
