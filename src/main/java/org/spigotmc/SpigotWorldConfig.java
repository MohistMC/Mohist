...
public class SpigotWorldConfig
{
    ...
    private int getAndValidateGrowth(String crop)
    {
        ...
        log( crop + " " +i18n.get("spigotworldconfig.8") + " " + modifier + "%" );
    ...
    private void itemMerge()
    {
        ...
        log( i18n.get("spigotworldconfig.7") + " " +  itemMerge );
    }
    ...
    private void expMerge()
    {
        ...
        log( i18n.get("spigotworldconfig.6") + " " + expMerge );
    }
    ...
    private void viewDistance()
    {
        ...
        log( i18n.get("spigotworldconfig.5") + " " + viewDistance );
    }
    ...
    private void mobSpawnRange()
    {
        ...
        log( i18n.get("spigotworldconfig.4") +" " +  mobSpawnRange );
    }
    ...
    private void itemDespawnRate()
    {
        ...
        log( i18n.get("spigotworldconfig.3") +" " +  itemDespawnRate );
    }
    ...
    private void activationRange()
    {
        ...
        log( i18n.get("spigotworldconfig.2")+" An " + animalActivationRange + " / Mo " + monsterActivationRange + " / Ra " + raiderActivationRange + " / Mi " + miscActivationRange + " / Tiv " + tickInactiveVillagers );
    }
    ...
    private void trackingRange()
    {
        ...
        log( i18n.get("spigotworldconfig.9")+" Pl " + playerTrackingRange + " / An " + animalTrackingRange + " / Mo " + monsterTrackingRange + " / Mi " + miscTrackingRange + " / Other " + otherTrackingRange );
    }
    ...
    private void hoppers()
    {
        ...
        log(i18n.get("spigotworldconfig.10", hopperTransfer, hopperCheck, hopperAmount));
    }
    ...
    private void arrowDespawnRate()
    {
        ...
        log(i18n.get("spigotworldconfig.11", arrowDespawnRate, tridentDespawnRate));
    }
    ...
    private void zombieAggressiveTowardsVillager()
    {
        ...
        log( i18n.get("spigotworldconfig.12") + " " + zombieAggressiveTowardsVillager );
    }
    ...
    private void nerfSpawnerMobs()
    {
        ...
        log( i18n.get("spigotworldconfig.13") + " " + nerfSpawnerMobs );
    }
    ...
    private void enableZombiePigmenPortalSpawns()
    {
        ...
        log( i18n.get("spigotworldconfig.14") +" " +  enableZombiePigmenPortalSpawns );
    }
    ...
    private void initWorldGenSeeds()
    {
        ...
        log(i18n.get("spigotworldconfig.15", villageSeed,
                desertSeed,
                iglooSeed,
                jungleSeed,
                swampSeed,
    ...
    private void maxTickTimes()
    {
        ...
        log(i18n.get("spigotworldconfig.16", tileMaxTickTime, entityMaxTickTime));
    }
