...
public final class PaperAdventure {
    ...
    private static final Codec<CompoundNBT, String, IOException, IOException> NBT_CODEC = new Codec<CompoundNBT, String, IOException, IOException>() {
        @Override
        public @NonNull
        CompoundNBT decode(final @NonNull String encoded) throws IOException {
            try {
        ...
        @Override
        public @NonNull
        String encode(final @NonNull CompoundNBT decoded) {
    ...
    public static Component asAdventure(final ITextComponent component) {
        return GSON.serializer().fromJson(ITextComponent.Serializer.toJsonTree(component), Component.class);
    }
    ...
    SoundCategory asVanillaNullable(final Sound.@Nullable Source source) {
        if (source == null) {
            return null;
        }
    ...
    public static @Nullable
    BinaryTagHolder asBinaryTagHolder(final @Nullable CompoundNBT tag) {
        if (tag == null) {
            return null;
        }
        try {
    ...
    TextColor asAdventure(TextFormatting minecraftColor) {
    ...
    public static @Nullable
    TextFormatting asVanilla(TextColor color) {
