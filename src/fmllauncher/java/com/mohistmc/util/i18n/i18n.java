...
public class i18n {
    ...
    public static String get(String key, Object... f) {
        return new MessageFormat(key).format(Arrays.stream(f).map(o1 -> NumberUtils.isNumber(String.valueOf(o1)) ? String.valueOf(BigDecimal.valueOf(Double.parseDouble(String.valueOf(o1)))) : String.valueOf(o1)).toArray());
    }
