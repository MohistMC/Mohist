    ...
    public static void startInstallation() throws Exception {
        ...
        if(mcpZip.exists()) {
            if(!mcpTxt.exists()) {
                ...
                mute();
                run("net.minecraftforge.installertools.ConsoleTool", new ArrayList<>(Arrays.asList("--task", "MCP_DATA", "--input", mcpZip.getAbsolutePath(), "--output", mcpTxt.getAbsolutePath(), "--key", "mappings")),
                        stringToUrl(new ArrayList<>(Arrays.asList(
                                libPath + "net/minecraftforge/srgutils/0.4.11/srgutils-0.4.11.jar",
                                libPath + "net/minecraftforge/installertools/1.3.0/installertools-1.3.0.jar",
                                libPath + "net/md-5/SpecialSource/1.8.5/SpecialSource-1.8.5.jar",
                                libPath + "net/sf/jopt-simple/jopt-simple/5.0.4/jopt-simple-5.0.4.jar",
                                libPath + "com/google/code/gson/gson/2.10/gson-2.10.jar",
                                libPath + "de/siegmar/fastcsv/1.0.2/fastcsv-1.0.2.jar",
                                libPath + "org/ow2/asm/asm-commons/9.6/asm-commons-9.6.jar",
                                libPath + "com/google/guava/guava/20.0/guava-20.0.jar",
                                libPath + "com/opencsv/opencsv/4.4/opencsv-4.4.jar",
                                libPath + "org/ow2/asm/asm-analysis/9.6/asm-analysis-9.6.jar",
                                libPath + "org/ow2/asm/asm-tree/9.6/asm-tree-9.6.jar",
                                libPath + "org/ow2/asm/asm/9.6/asm-9.6.jar"))));
                unmute();
            }
        } else {
        ...
        if(!slim.exists() || !extra.exists()) {
            ...
            mute();
            run("net.minecraftforge.jarsplitter.ConsoleTool", new ArrayList<>(Arrays.asList("--input", libPath + "minecraft_server.1.16.5.jar", "--slim", slim.getAbsolutePath(), "--extra", extra.getAbsolutePath(), "--srg", mcpTxt.getAbsolutePath())),
                    stringToUrl(Arrays.asList(
                            libPath + "net/minecraftforge/jarsplitter/1.1.4/jarsplitter-1.1.4.jar",
                            libPath + "net/minecraftforge/srgutils/0.4.11/srgutils-0.4.11.jar",
                            libPath + "net/sf/jopt-simple/jopt-simple/5.0.4/jopt-simple-5.0.4.jar")));
            unmute();
        }
        ...
        if(!srg.exists()) {
            ...
            run("net.md_5.specialsource.SpecialSource", new ArrayList<>(Arrays.asList("--in-jar", slim.getAbsolutePath(), "--out-jar", srg.getAbsolutePath(), "--srg-in", mcpTxt.getAbsolutePath())),
                    stringToUrl(Arrays.asList(
                            libPath + "net/md-5/SpecialSource/1.8.5/SpecialSource-1.8.5.jar",
                            libPath + "org/ow2/asm/asm-commons/6.1.1/asm-commons-6.1.1.jar",
                            libPath + "net/sf/jopt-simple/jopt-simple/5.0.4/jopt-simple-5.0.4.jar",
                            libPath + "com/google/guava/guava/20.0/guava-20.0.jar",
                            libPath + "net/sf/opencsv/opencsv/4.4/opencsv-4.4.jar",
                            libPath + "org/ow2/asm/asm-analysis/6.1.1/asm-analysis-6.1.1.jar",
                            libPath + "org/ow2/asm/asm-tree/6.1.1/asm-tree-6.1.1.jar",
                            libPath + "org/ow2/asm/asm/6.1.1/asm-6.1.1.jar")));
        }
        ...
        if(!serverJar.exists()
            ...
            mute();
            run("net.minecraftforge.binarypatcher.ConsoleTool", new ArrayList<>(Arrays.asList("--clean", srg.getAbsolutePath(), "--output", serverJar.getAbsolutePath(), "--apply", lzma.getAbsolutePath())),
                    stringToUrl(new ArrayList<>(Arrays.asList(
                            ...
                            libPath + "com/google/guava/guava/20.0-jre/guava-20.0-jre.jar",
                            libPath + "net/sf/jopt-simple/jopt-simple/5.0.4/jopt-simple-5.0.4.jar",
